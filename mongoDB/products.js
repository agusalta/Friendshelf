...
export async function insertProperties(db, col, jsonData) {
    try {
        ...
        const { product_id, product_description, product_name, product_logo, rating, reviews, what_is, star_distribution, initial_reviews } = jsonData;
        ...
        const document = { product_id, product_description, product_name, star_distribution, initial_reviews, product_logo, rating, reviews, what_is };
